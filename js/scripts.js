(function ($, root, undefined) {
	...
	$(function () {
		...
		'use strict';
			...
			const navmenu = document.querySelectorAll('nav.menu > .menu');
			Array.from(navmenu).forEach(link => link.addEventListener('click', (ev) => {
				ev.preventDefault();
	...
	//Add sparkle to links
	$(function() {

		$(".content-container a").sparkleh({
			color: "rainbow",
			count: 100,
			overlap: 10
		});
